 ...
 timeOfTemp.push_back(timeOfReading);
  ...
  while(Serial.available())
    ...
    if(inputString.equals("send")){    
      int j;
      while( tempInCelsius.size() > 0 ) {         //Extracting the saved readings in the vector and deleting them
        int tempSize = tempInCelsius.size() - 1;
        int timeSize = timeOfTemp.size() - 1;
    ...
    inputString = "";
       ...
       delay(15000);                  //waiting 15 second to start the reading and saving the time
